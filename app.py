...
<input type="submit" value="rock" name="weapon">
  <svg id="rock" enable-background="new 0 0 512.003 512.003" height="512" viewBox="0 0 512.003 512.003" width="512" xmlns="http://www.w3.org/2000/svg">
    <g>
